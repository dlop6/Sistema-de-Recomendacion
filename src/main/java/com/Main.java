...
public class Main {
    ...
    public static void crearNodosPelicula(Driver driver, String persona){
        String query = "CREATE (user:Pelicula {name: '" + persona +"'})";
    ...
    public static void crearNodosDirector(Driver driver, String persona){
        String query = "CREATE (user:Director {name: '" + persona +"'})";
        try (Session session = driver.session()){
            session.writeTransaction(tx -> {
                tx.run(query);
                return null;
    ...
    public static void crearNodosActor(Driver driver, String persona){
        String query = "CREATE (user:Actor {name: '" + persona +"'})";
        try (Session session = driver.session()){
            session.writeTransaction(tx -> {
                tx.run(query);
                return null;
    ...
    public static void crearNodosGenero(Driver driver, String persona){
        String query = "CREATE (user:Genero {name: '" + persona +"'})";
        try (Session session = driver.session()){
            session.writeTransaction(tx -> {
                tx.run(query);
                return null;
